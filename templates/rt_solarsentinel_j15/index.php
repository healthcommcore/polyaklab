...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-31224017-1']);
			...
			<div class="wrapper"><div id="body-left" class="png"><div id="body-right" class="png">
				...
				<div id="top-bar">
					<div class="topbar-strip">
						...
						<div id="accessibility">
							...
							<div class="textsizer-desc"><?php echo JText::_('Text size'); ?></div>
						</div>
						<?php endif; ?>
				...
				<div id="header-bar">
                    ...
                    <div id="search_logos">
                        ...
                        <jdoc:include type="modules" name="logos" style="xhtml" />
                        <?php endif; ?>
                    </div>
				</div>
				<?php endif; ?>
						...
						<div id="main-content" class="<?php echo $col_mode; ?>">
						    <div class="colmask leftmenu">
						        <div class="colmid">
    					    	    <div class="colright">
        						        <!--Begin col1wrap -->    
            						    <div class="<?php echo JRequest::getVar('id') == 1 ? "home_wrap" : "col1wrap"; ?>">
            						        <div class="col1pad">
            						            <div class="col1">
                    						        <div id="maincol2">
